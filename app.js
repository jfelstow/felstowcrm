...
const PLATFORMS      = ['Stripe','Square','PayPal','Venmo','Cash App','Zelle','Shopify Payments','WooCommerce','QuickBooks Payments','Apple Pay / Google Pay','ACH (direct bank)','Checks','Cash','Other merchant processor'];
